...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Laborotatorios <small> > Lista de </small></h1>
<!-- end page-header -->
<!-- begin panel -->
        ...
        <table id="tblAnalisis" class="table table-striped table-bordered table-td-valign-middle" style="width:100%;">
            <thead>
                <tr>
                    ...
                    <th width="10%" class="text-rap" class="text-center">RNC</th>
...
<script>
    ...
    $.getScript('assets/admin/plugins/datatables.net/js/jquery.dataTables.min.js?<?php echo time(); ?>').done(function () {
        $.when(
            ...
            $.getScript('js/laboratorio/laboratorio.js?<?php echo time(); ?>'),
                    $.Deferred(function (deferred) {
                        $(deferred.resolve);
                    })
        });
