...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Reportes <small> >Reporte resultados </small></h1>
<!-- end page-header -->
<!-- begin panel -->
<div class="panel panel-inverse">
    ...
    <div class="panel-body table-responsive">
        <table id="tblAnalisis" class="table table-striped table-bordered table-td-valign-middle" style="width:100%;">
            <thead>
                <tr>
                    <th width="8%" class="text-rap" class="text-center">ORDEN</th>
                    <th width="8%" class="text-rap" class="text-center">NOMBRE PACIENTE</th>
                    <th width="8%" class="text-rap" class="text-center">CEDULA</th>
                    <th width="8%" class="text-rap" class="text-center">FECHA</th>
                    <th width="8%" class="text-rap" class="text-center">OPCIONES</th>
                    <th width="8%" class="text-rap" class="text-center">IMPRIMIR</th>
                </tr>
            </thead>
            <tbody>
...
<script>
    ...
    $.getScript('assets/admin/plugins/datatables.net/js/jquery.dataTables.min.js?<?php echo time(); ?>').done(function () {
        $.when(
            ...
            $.getScript('js/reporte_resultado/reporte_resultado.js?<?php echo time(); ?>'),
                    $.Deferred(function (deferred) {
                        $(deferred.resolve);
                    })
        });
