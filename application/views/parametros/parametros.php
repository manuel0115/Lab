...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Analisis <small> > Parametros </small></h1>
<!-- end page-header -->
<!-- begin panel -->
<div class="panel panel-inverse">
    ...
    <div class="panel-body table-responsive">
        <table id="tblAnalisis" class="table table-striped table-bordered table-td-valign-middle" style="width:100%;">
            <thead>
                <tr>
                    <th width="8%" class="text-rap" class="text-center">ID</th>
                    <th width="8%" class="text-rap" class="text-center">Nombre</th>
                    <th width="8%" class="text-rap" class="text-center">Analisis</th>
