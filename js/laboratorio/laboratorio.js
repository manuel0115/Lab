    ...
    },
    {
      ...
      mRender: function (data, type, full) {
        return (
          ...
          full.ID +
          '"  class="btn btn-primary btn_editar_laboratorio" ><i class="fa fa-edit"></a>'
        );
      },
    },
  ],
  ...
  buttons: [
    {
      ...
      text:
        '<span class="btn-label"><i class="fa fa-plus"></i></span>&nbsp;Agregar Laboratorio',
      action: function (nButton, oConfig, oFlash) {
        $(".modal_usuarios .modal-content").load(
          "laboratorio/getModaLaboratorio",
          function () {
...
$("#tblAnalisis").on("click", ".btn_editar_laboratorio", function () {
  id = btoa(btoa(btoa($(this).attr("id"))));

  $(".modal_usuarios .modal-content").load(
    "laboratorio/getModaLaboratorio/" + id,
    function () {
      $(".modal_usuarios").modal({
        backdrop: "static",
        keyboard: false,
